            ...
            <div class="choose_section_2 layout_padding">
               <div class="row">
                     ...
                     <div class="choose_box">
                        <div class="number_1">
                           <img src="room/x.jpg" alt="">
                                             ...
                                             <?php
                                                      $sql="SELECT`roomN`, `Descp`, `status`, `price`, `qty` FROM `products` order by qty limit 1";
                                                      $res=$con->query($sql);
                                                      while($row = mysqli_fetch_object($res)){
                                                           
                                                       echo"<p class='dummy_text'>ROOM: $row->roomN</p>";
                                                       echo"<p class='dummy_text'>ROOM DETAIL: $row->Descp</p>";
                                                       echo"<p class='dummy_text'>ROOM STATUS: $row->status</p>"; 
                                                       echo"<p class='dummy_text'>PRICE:$$row->price</p>"; 
                                                       echo"<p class='dummy_text'>Quantity: $row->qty</p>";  
                                                      }
                  ...
                  <div class="col-md-4">
                     <div class="choose_box">
                        <div class="number_1">
                           <img src="room/sad.jpg" alt="">
                        </div>
                        <?php
                                                      $sql="SELECT * FROM `products` order by id asc  limit 1";
                                                      $res=$con->query($sql);
                                                      while($row = mysqli_fetch_object($res)){
