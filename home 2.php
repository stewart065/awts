...
<html lang="en">   
   ...
   <body>
      ...
      <div class="header_section maypagkaorange">
         <div class="container-fluid ">
            <div class="costum_header">
               <div class="logo"><a href="profile.html"><img src="images/logo.png"></a></div>
               <div class="contact_menu">
                  <ul>
                     <li><img src="images/call-icon.png" class="padding_left_23"><a href="#">Call:0919 071 9081</a></li>
                     <li><img src="images/mail-icon.png" class="padding_right_6"><a href="#">Email:fourkseasideresto@gmail.com</a></li>
                     <li><img src="images/map-icon.png" class="padding_right_3"><a href="#">Location: San Vicente St.Bogo</a></li>
                     <li><a class="wed" href="profile.php"><img src="images/ht.png" style=" width: 65px; height:65px; margin-top: -70px; margin-left: 900px; "> </a></li>
                  </ul>
               </div>
               <div class="menu_text">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="banner_taital">
                              ...
                              <p class="banner_text">4k's Seaside PentHouse & Spa offers you a privileged experience combining comfort and conviviality.</p>
                           </div>
                           <div class="btn_main">
                  ...
                  <div class="carousel-item">
                     <div class="row">
                        <div class="col-md-6">
                           <div class="banner_taital">
                              <h1 class="banner_taital">Come, stay and enjoy your day.</h1>
                              <p class="banner_text">Whether you are a backpacker, a solo traveler or with your family, our hotel & Spa with top-of-the-range service will meet all your expectations.</p>
                           </div>
                           <div class="btn_main">
                              <div class="quote_bt active"><a href="choose.php">Book Now</a></div>
                              <div class="contact_bt"><a href="#">Contact Us</a></div>
                  ...
                  <div class="carousel-item">
                     <div class="row">
                        <div class="col-md-6">
                           <div class="banner_taital">
                              <h1 class="banner_taital">Come, stay and enjoy your day.</h1>
                              <p class="banner_text">More than just a hotel, 4k's Seaside PentHouse & Spa offers you a place to live and meet people.</p>
                           </div>
                           <div class="btn_main">
                              <div class="quote_bt active"><a href="choose.php">Book Now</a></div>
                              <div class="contact_bt"><a href="#">Contact Us</a></div>
      ...
      <div class="providing_section_2 layout_padding ">
         <div class="container">
            <h2 class="clean_text">4k's Seaside Hotel & Spa </h2>
            <p class="ipsum_text"> 4k's Seaside  Hotel & Spa is a family-friendly hotel that offers a wide range of accommodation types, from rooms to suites. All this in the peaceful surroundings we will make your time at Bogo City San Vicente St. an unforgettable holiday. </p>
