<?php
            ...
            $sql="SELECT`Arrival`, `Departure`, `FirstN`, `LastN`, `Email`, `Phone`, `Adults`, `Children`, `Roomid`, `price`, `qty` FROM `res` order by id desc limit 1";
            $res = $con->query($sql);
            $row = $res->fetch_assoc();
    ...
    <div class="container d-lg-flex"> 
        <div class="box-1 bg-light user"> 
            <div class="d-flex align-items-center mb-3"> 
                ...
                <p class="ps-2 name"><?php echo $_SESSION['uname']?></p> </div> <div class="box-inner-1 pb-3 mb-3 "> <div class="d-flex justify-content-between mb-3 userdetails"> <p class="fw-bold"><?php echo $row['Roomid']?></p> 
                        <?php
                        
                            ?>
                <p class="fw-lighter"><span class="fas fa-dollar-sign"></span><?php echo $row['price']?></p> 
            </div> 
            ...
            <div class="carousel-inner"> 
                ...
                <button class="carousel-control-prev" type="button" data-bs-target="#my" data-bs-slide="prev">
                    ...
                    <button class="carousel-control-next" type="button" data-bs-target="#my" data-bs-slide="next"> <div class="icon"> <span class="fas fa-arrow-right"></span> </div> <span class="visually-hidden">Next</span> </button> </div> 
                    <p class="dis my-3 info">ROOM NAME: <?php echo $row['Roomid']?></p>
                     <p class="dis mb-3 updates"> Arrival: <?php echo $row['Arrival']?></p> 
                     <p class="dis mb-3 different">DEPARTURE: <?php echo $row['Departure']?></p> 
                     
                    <div class="dis">
                         <p class="black">Name: <?php echo $row['FirstN']?> <?php echo $row['LastN']?></p> <br>
                         <p class="white">Email: <?php echo $row['Email']?></p> <br>
                         <p class="pastel">Phone: <?php echo $row['Phone']?></p> 
                        </div> 
                        <div> 
                            <p class="dis footer my-3">Number of People:</p> 
                            <span class="fas fa mb-3 pe-2"> Adult: <?php echo $row['Adults']?> </span> <br>
                            <span class="fas fa mb-3 pe-2"> Children: <?php echo $row['Children']?> </span>
                        </div> 
                    </div>
            </div> 
                 <div class="box-2"> 
                    ...
                    <div class="d-flex align-items-center justify-content-between card-atm border rounded"> 
                        ...
                        <div class="my-3 cardname"> 
                            <p class="dis fw-bold mb-2">NAME</p> 
                             <input class="form-control" type="text" value="<?php echo $row['FirstN']?> <?php echo $row['LastN']?>" disabled> 
                        </div>
                        ...
                        <div class="address"> 
                            ...
                            <div class=" my-3"> 
                                <p class="dis fw-bold mb-2">Price</p> 
                                <div class="inputWithcheck"> 
                                    <input class="form-control" type="text" name="pricesa" value="<?php echo $row['price']?>"disabled> 
                                    <span class="fas fa-check"></span> </div> 
                                </div> 
                                <div class="my-3"> 
                                        <p class="dis fw-bold mb-2">Quantity</p> 
                                        <input class="form-control text-uppercase" type="text" name="qtysa" value="<?php echo $row['qty']?>"disabled> 
                                </div> 
                                <div class="my-3"> 
                                        <p class="dis fw-bold mb-2">Amount</p> 
                                        <input class="form-control text-uppercase" type="text" placeholder = "Enter Amount" name="totals"> 
                                </div> 
                                <?php
                                        $sql = "SELECT price, qty FROM res order by id desc";
                                        $res = $con->query($sql);
                                        if (!$res) {
                                            die("Error: " . $con->error);
                                        }
                                        $row = $res->fetch_assoc();
                                        $total_cost = $row["price"] * $row["qty"];
                                        $con->close();
                                ...
                                <div class="d-flex flex-column dis">
                                         <div class="d-flex align-items-center justify-content-between mb-2">
                                            ...
                                            <p><span class="fas fa-dollar-sign"></span> <input type="text" name="substotal" value="<?php echo $total_cost?>"></p>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-2"> 
                                                <p class="fw-bold">Total</p> <p class="fw-bold">
                                                    <span class="fas fa-dollar-sign"></span><input type="text" name="totalsale"value="<?php echo $total_cost?>">
                                                </p> 
                                            </div> 
